                        ...
                        if (!userMenus.isEmpty()) {
                            for (String menu : userMenus) {
                                ...
                                switch (menu) {
                                    ...
                                    case "Inventory": menuUrl = "list_inventory.jsp"; break;
                                    case "Meja": menuUrl = "list_tables.jsp"; break;
                                    case "Reservasi": menuUrl = "list_reservations.jsp"; break;
                                    case "Pesanan": menuUrl = "list_orders.jsp"; break;
                                    case "Laporan Penjualan": menuUrl = "list_sales_reports.jsp"; break;
                                    case "Program Penjualan": menuUrl = "list_sales_programs.jsp"; break;
                                }
                    %>
                    <li class="nav-item">
